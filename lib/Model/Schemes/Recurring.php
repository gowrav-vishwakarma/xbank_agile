...
class Model_Schemes_Recurring extends Model_Schemes {
    ...
    function init(){
 	...
 	function newSchemeForm(&$owner){
        ...
        $form->setModel('Schemes_Recurring',array('Name','MinLimit','MaxLimit','balance_sheet_id','Interest','NumberOfPremiums','PremiumMode','balance_sheet_id','MaturityPeriod','SchemePoints','SchemeGroup','ActiveStatus','AccountOpenningCommission','CollectorCommissionRate'));
